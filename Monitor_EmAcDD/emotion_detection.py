...
class EmotionDetector:
    def __init__(self, model_repo="Ganaa614/emotion-cnn-model_binary"):
        ...
        # Binary emotion labels for downstream consistency
        self.emotion_labels = ['stressed', 'not_stressed']
        self.model = None
    ...
    def draw_emotion(self, img, emotion, confidence, face_box):
        ...
        # Color map aligned with binary emotions
        color_map = {
            'stressed': (0, 0, 255),        # Red
            'not_stressed': (0, 200, 0),    # Green
        }
